...
<form action="#" method="post" enctype="multipart/form-data" style="width: 610px;margin:0 auto 50px;">
   <table id="add">
       ...
       <tr>
           <td><input type="number" required name="giasp"/>VNĐ</td>
       </tr>
       <tr>
           <td><br>Giảm giá:</td>
       </tr>
       <tr>
           <td><input type="text" required name="giamgia"/></td>
       </tr>
       <tr>
           <td><br>Thông tinh Sản Phẩm:</td>
       </tr>
       <tr>   
           <td><textarea rows="5" cols="35" required style="resize:none" name="ttsp" id="hquang"></textarea></td>
           <script type="text/javascript">CKEDITOR.replace('hquang'); </script>
       </tr>
       <tr>
       ...
       <tr>
           <td><br><input type="submit" value="Thêm sản phẩm" name="themsp" style="font-weight: bold;background: gray;color: white;font-size: 18px;height: 50px;"></td>
       </tr>                        
   </table>
</form>
