            ...
            <section>                                
                ...
                <?php
                    if(isset($_POST['dangky'])){       
                        ...
                        $sql6= " insert into khachhang(name, birthday, gender, email, phonenumber, comment) values ('$hvten','$ngaysinh','$gioitinh','$email','$nphone','$comments')";
             ...
             <form action="#" method="post" name="myForm" onsubmit="return validateForm()" > 
                 ...
                 <table style="width: 350px;margin: auto"> 
                     <tr>
                         <td width="118" style="width: 50%;">Họ và tên:</td> <style>td{padding-top: 20px;}</style>
