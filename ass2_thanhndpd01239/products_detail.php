            ...
            <section>
                ...
                <article id="right">
                    <article class="detail">
                        <article class="detail-off"><span><?php echo $row["saleoff"] ?>% OFF</span></article>
                    ...
                    <article id="controlll">
                        ...
                        <div id="cont">
                            <div class="tab-pane active" id="adm"><?php echo $row["thongtinhsp"] ?></div>
                            <div class="tab-pane" id="cus"></div>
                         </div> 
                    </article>
                </article>
